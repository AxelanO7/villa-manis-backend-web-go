...
func Connect() {
	...
	db.AutoMigrate(&model.Account{}, &model.Category{}, &model.DetailInput{}, &model.DetailJournal{}, &model.DetailOutput{}, &model.GeneralCart{}, &model.GeneralJournal{}, &model.Input{}, &model.Output{}, &model.User{})
